...
[n_a_guess,n_n_guess,c_n_guess,m_n_star,c_a_guess,m_a_star,cap_a_star,psi_guess,joint_distr,R_fc,W_fc,Profits_fc,Output,grid]...
...
%% Save
filename=[casename];
save(filename,'-regexp', '^(?!(TayRule_case|save_IRF_data|com_fig_name)$).')
