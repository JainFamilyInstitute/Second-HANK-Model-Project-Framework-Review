...
% function F which is written in Schmitt-Grohe Uribe form using the algorithm
...
if isempty(p)
    c = parcluster;
    parpool(pool,2); % total = 26 divisble by 2
    p = gcp('nocreate');
end
...
F2((mpar.nm+mpar.nk-2):numstates-2,:)=0;

%% Schmidt-Grohe and Uribe code based on qz decomposition of the system
