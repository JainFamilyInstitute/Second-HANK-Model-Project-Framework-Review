...
! Local variables
    ...
    ww=0
    do i1 = 1,nm
!$OMP PARALLEL DO SHARED(i1,idm,weight,m_n_star,gridm,E_rhs_mu,mu_flow) PRIVATE(i2,index,aux) 
        do i2 = 1,ncols
            index=idm(i1,i2)
...
!$OMP END PARALLEL DO
    ...
    do i1 = 1,nm
!$OMP PARALLEL DO SHARED(i1,idm,ww,outaux,beta,nu,weight,mu_flow) PRIVATE(i2,index,aux) 
        do i2 = 1,ncols
            index=idm(i1,i2)
